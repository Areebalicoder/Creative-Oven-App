...
import { Text, View,Image,TextInput,TouchableOpacity,StyleSheet, Linking} from 'react-native';

export default class HomeScreen extends React.Component{
  youtubePress = async () => {
    const instagramURL = `https://www.youtube.com/channel/UCKU96RGI-6XvJNGy9r2GflQ`;
    return Linking.openURL(instagramURL);
  };
  fbPress = async () => {
    const instagramURL = `https://www.facebook.com/CreativeOvenbyRainna`;
    return Linking.openURL(instagramURL);
  };
  instaPress = async () => {
    const instagramURL = `https://www.instagram.com/rainna_creativeoven/`;
    return Linking.openURL(instagramURL);
  };
  contact=()=>{
    alert('Call: +91 844712003')
  }
  ...
  render(){
    return(
      ...
      <TouchableOpacity style={{alignSelf:"flex-start"}} onPress={this.instaPress}>       
       <Image 
       ...
       <TouchableOpacity style={{alignSelf:"center", marginTop:-67}} onPress={this.fbPress}>
       <Image 
         style = {{ height: 50, width: 50}}
       ...
       <TouchableOpacity style={{alignSelf:"flex-end", marginTop:-67}} onPress={this.youtubePress}>
       <Image 
         style = {{ height: 50, width: 50}}
