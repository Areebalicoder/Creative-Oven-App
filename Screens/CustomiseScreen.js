...
import { Text, View,Image,TouchableOpacity,StyleSheet,ScrollView,TextInput, KeyboardAvoidingView, Share, Alert} from 'react-native';
  ...
  constructor() {
    ...
    this.state = {
     ...
     SubPre= async()=>{
       ...
       alert("gmail creativeoven@gmail71.com")
